...
MVA VARIABLES=Pre_Biological_Basis1 Pre_Biological_Basis4 Pre_Biological_Basis5 
    Pre_Biological_Basis7 PRE_BIOLOGICAL_BASIS2_RECODE PRE_BIOLOGICAL_BASIS3_RECODE 
    PRE_BIOLOGICAL_BASIS6_RECODE PRE_BIOLOGICAL_BASIS8_RECODE PRE_DISTINCTIVENESS3_RECODE 
    PRE_DISTINCTIVENESS5_RECODE PRE_DISTINCTIVENESS7_RECODE PRE_DISTINCTIVENESS8_RECODE 
    PRE_INFORMATIVENESS3_RECODE PRE_INFORMATIVENESS4_RECODE PRE_INFORMATIVENESS6_RECODE 
    POST_BIOLOGICAL_BASIS2_RECODE POST_BIOLOGICAL_BASIS3_RECODE POST_BIOLOGICAL_BASIS6_RECODE 
    POST_BIOLOGICAL_BASIS8_RECODE POST_DISTINCTIVENESS3_RECODE POST_DISTINCTIVENESS5_RECODE 
    POST_DISTINCTIVENESS7_RECODE POST_DISTINCTIVENESS8_RECODE POST_INFORMATIVENESS3_RECODE 
    POST_INFORMATIVENESS4_RECODE POST_INFORMATIVENESS6_RECODE Pre_Distinctiveness1 Pre_Distinctiveness2 
    ...
    Post_Biological_Basis5 Post_Biological_Basis7 Post_Distinctiveness1 Post_Distinctiveness2 
    Post_Distinctiveness4 Post_Distinctiveness6 Post_Informativeness1 Post_Informativeness2 
    Post_Informativeness5 Post_Informativeness7 Economic_Policies
  /MPATTERN PERCENT=1
  /EM(TOLERANCE=0.001 CONVERGENCE=0.0001 ITERATIONS=25 OUTFILE='/Users/MaddyMillar/SPSSFiles/file10.sav').
...
MVA VARIABLES=Economic_Policies_EM Pre_Biological_Basis1_EM Pre_Biological_Basis4_EM 
    Pre_Biological_Basis5_EM Pre_Biological_Basis7_EM Pre_Distinctiveness1_EM Pre_Distinctiveness2_EM 
    Pre_Distinctiveness4_EM Pre_Distinctiveness6_EM Pre_Informativeness1_EM Pre_Informativeness2_EM 
    Pre_Informativeness5_EM Pre_Informativeness7_EM Post_Biological_Basis1_EM Post_Biological_Basis4_EM 
    Post_Biological_Basis5_EM Post_Biological_Basis7_EM Post_Distinctiveness1_EM 
    Post_Distinctiveness2_EM Post_Distinctiveness4_EM Post_Distinctiveness6_EM Post_Informativeness1_EM 
    Post_Informativeness2_EM Post_Informativeness5_EM Post_Informativeness7_EM 
    PRE_BIOLOGICAL_BASIS2_RECODE_EM PRE_BIOLOGICAL_BASIS3_RECODE_EM PRE_BIOLOGICAL_BASIS6_RECODE_EM 
    PRE_BIOLOGICAL_BASIS8_RECODE_EM PRE_DISTINCTIVENESS3_RECODE_EM PRE_DISTINCTIVENESS5_RECODE_EM 
    PRE_DISTINCTIVENESS7_RECODE_EM PRE_DISTINCTIVENESS8_RECODE_EM PRE_INFORMATIVENESS3_RECODE_EM 
    PRE_INFORMATIVENESS4_RECODE_EM PRE_INFORMATIVENESS6_RECODE_EM POST_BIOLOGICAL_BASIS2_RECODE_EM 
    POST_BIOLOGICAL_BASIS3_RECODE_EM POST_BIOLOGICAL_BASIS6_RECODE_EM POST_BIOLOGICAL_BASIS8_RECODE_EM 
    POST_DISTINCTIVENESS3_RECODE_EM POST_DISTINCTIVENESS5_RECODE_EM POST_DISTINCTIVENESS7_RECODE_EM 
    POST_DISTINCTIVENESS8_RECODE_EM POST_INFORMATIVENESS3_RECODE_EM POST_INFORMATIVENESS4_RECODE_EM 
    POST_INFORMATIVENESS6_RECODE_EM .

COMPUTE Pre_Biological_Basis=MEAN(PRE_BIOLOGICAL_BASIS2_RECODE_EM,PRE_BIOLOGICAL_BASIS3_RECODE_EM,
    PRE_BIOLOGICAL_BASIS6_RECODE_EM,PRE_BIOLOGICAL_BASIS8_RECODE_EM,Pre_Biological_Basis1_EM,
    Pre_Biological_Basis4_EM,Pre_Biological_Basis5_EM,Pre_Biological_Basis7_EM).
EXECUTE.

COMPUTE Pre_Distinctiveness=MEAN(PRE_DISTINCTIVENESS3_RECODE_EM,PRE_DISTINCTIVENESS5_RECODE_EM,
    PRE_DISTINCTIVENESS7_RECODE_EM,PRE_DISTINCTIVENESS8_RECODE_EM,Pre_Distinctiveness1_EM,
    Pre_Distinctiveness2_EM,Pre_Distinctiveness4_EM,Pre_Distinctiveness6_EM).
EXECUTE.

COMPUTE Pre_Informativeness=MEAN(PRE_INFORMATIVENESS3_RECODE_EM,PRE_INFORMATIVENESS4_RECODE_EM,
    PRE_INFORMATIVENESS6_RECODE_EM,Pre_Informativeness1_EM,Pre_Informativeness2_EM,
    Pre_Informativeness5_EM,Pre_Informativeness7_EM).
EXECUTE.

COMPUTE Pre_Essentialism=MEAN(Pre_Biological_Basis,Pre_Distinctiveness,Pre_Informativeness).
EXECUTE.

COMPUTE Post_Biological_Basis=MEAN(POST_BIOLOGICAL_BASIS2_RECODE_EM,
    POST_BIOLOGICAL_BASIS3_RECODE_EM,POST_BIOLOGICAL_BASIS6_RECODE_EM,POST_BIOLOGICAL_BASIS8_RECODE_EM,
    Post_Biological_Basis1_EM,Post_Biological_Basis4_EM,Post_Biological_Basis5_EM,
    Post_Biological_Basis7_EM).
EXECUTE.

COMPUTE Post_Distinctiveness=MEAN(POST_DISTINCTIVENESS3_RECODE_EM,POST_DISTINCTIVENESS5_RECODE_EM,
    POST_DISTINCTIVENESS7_RECODE_EM,POST_DISTINCTIVENESS8_RECODE_EM,Post_Distinctiveness1_EM,
    Post_Distinctiveness2_EM,Post_Distinctiveness4_EM,Post_Distinctiveness6_EM).
EXECUTE.

COMPUTE Post_Informativeness=MEAN(POST_INFORMATIVENESS3_RECODE_EM,POST_INFORMATIVENESS4_RECODE_EM,
    POST_INFORMATIVENESS6_RECODE_EM,Post_Informativeness1_EM,Post_Informativeness2_EM,
    Post_Informativeness5_EM,Post_Informativeness7_EM).
EXECUTE.
...
SORT CASES  BY Priming.
SPLIT FILE LAYERED BY Priming.
